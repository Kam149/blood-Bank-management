...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2018 at 10:56 AM
...
CREATE TABLE `requestes` (
  ...
  `Gender` varchar(100) NOT NULL,
  `AGE` varchar(100) NOT NULL,
  `Moblie NO` varchar(100) NOT NULL,
  `Email` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `requestes` (`Blood Group`, `Name`, `Gender`, `AGE`, `Moblie NO`, `Email`) VALUES
('kamakshi trivedi', 'female', '18', '123456', 'kamakshitrivedi149@gmail.com', 'A-'),
('A-', 'acdf ghi', 'male', '16', '12345767', 'asd@gmail.com');
